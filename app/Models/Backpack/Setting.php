...
class Setting extends Model
{
    ...
    protected $fillable = [
        'name', 'key', 'value', 'field', 'description', 'active'
    ];
    /**
     * Model Boot function
    ...
    public function getValueFunction()
    {
        ...
        switch ($type) {
            case 'text':
                ...
                break;
            case 'url':
                return IMCrudHelper::getSettingsUrlColumn($value);
                break;
            case 'email':
                return IMCrudHelper::getSettingsEmailColumn($value);
                break;
            case 'checkbox':
                return IMCrudHelper::getSettingsCheckboxColumn($value);
                break;
            case 'image':
                return IMCrudHelper::getSettingsImageColumn($value);
                break;
            case 'password':
                return IMCrudHelper::getSettingsPasswordColumn();
                break;
            case 'number':
                return $value;
                break;
            case 'icon_picker':
                return IMCrudHelper::getSettingsIconColumn($value);
                break;
            default:
                return $type;
                break;
